...
python -m PyInstaller --noconfirm --name="trackora-dashboard" --icon="trackora/assets/trackora_logo.ico" --add-data="trackora/assets;trackora/assets" --hidden-import="windows" --hidden-import="windows.daemon" --hidden-import="windows.startup" --hidden-import="windows.tracker" $excludes trackora/gui/__main__.py
