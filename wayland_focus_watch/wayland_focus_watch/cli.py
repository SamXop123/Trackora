...
from wayland_focus_watch.detector import FocusDetector
from wayland_focus_watch.format_output import format_focus_line


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Print the focused GNOME/Wayland application every few seconds."
    )
    parser.add_argument(
        "--interval",
        type=float,
